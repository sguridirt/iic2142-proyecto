...
question1_eval1 = EvaluationQuestion.find_or_create_by(content: "What is 2 + 2?", evaluation: evaluation1, max_points: 10)
question2_eval1 = EvaluationQuestion.find_or_create_by(content: "What is the derivative of x^2?", evaluation: evaluation1, max_points: 10)
question1_eval2 = EvaluationQuestion.find_or_create_by(content: "Define a vector space.", evaluation: evaluation2, max_points: 10)
question2_eval2 = EvaluationQuestion.find_or_create_by(content: "What is a basis in linear algebra?", evaluation: evaluation2, max_points: 10)
question1_eval3 = EvaluationQuestion.find_or_create_by(content: "What is the integral of x?", evaluation: evaluation3, max_points: 10)
question1_eval4 = EvaluationQuestion.find_or_create_by(content: "What is the limit of 1/x as x approaches infinity?", evaluation: evaluation4, max_points: 10)
...
answer3 = EvaluationAnswer.find_or_create_by(content: "A set with two operations", points: 0, evaluation_status: 1, evaluation_question: question1_eval2, student: student)
answer4 = EvaluationAnswer.find_or_create_by(content: "Set of vectors", points: 0, evaluation_status: 1, evaluation_question: question2_eval2, student: student)
...
conversation1 = Conversation.find_or_create_by(is_group: true)
